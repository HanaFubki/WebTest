...
<html>
<head>
    <title>用Session方式接收</title>
</head>
<body>
    <%
        String name = "";
        HttpSession req_session = request.getSession();
        name = (String)req_session.getAttribute("name");
        if(name.equals("")){
            ...
            if(name.equals("default") && password.equals("123456")){
                ...
                request.getRequestDispatcher("./Send_Session.jsp").forward(request , response);
            }
        }
    %>
    <h2>登录保护页面</h2>
    <h4>欢迎<%=name%>访问本系统，点击【<a href="./LogOut_Session.jsp">注销</a>】</h4>
