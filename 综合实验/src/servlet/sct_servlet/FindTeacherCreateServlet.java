...
@WebServlet("/WebTest8/findTeacherCreateServlet")
public class FindTeacherCreateServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<SCT_Course> list = service.getCourseByTea(tid , startCount);
        int count = service.getCourseCountByTea(tid);
        ...
        if(count > 0){
            ...
            for(int i = 0 ; i < list.size() ; i++){
                ...
                sb.append(
                        "                    <tr>\n" +
                                ...
                                "                        <td>" +
                                "                           <a href=\"javascript:void(0);\" onclick=\"deleteClass(" + course.getCid() + ")\">删除课程</a>" +
                                "                           <a href=\"javascript:void(0);\" onclick=\"updateClass(" + course.getCid() + ")\">修改课程</a>" +
                                "</td>" +
                                "</tr>");
            };
            ...
            for(int i = 0 ; i < totalCount ; i++){
                sb.append("            <a href=\"javascript:void(0);\" onclick=\"find_myself_create(" + i + ")\">" + (i + 1) + "</a>\n");
            }
            sb.append("        </div>");
        }else{
            sb.append("您目前没有发布课程哦...");
        }
